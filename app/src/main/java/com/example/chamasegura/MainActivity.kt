...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                ...
                R.id.fragment_burn_history_icnf,
                R.id.fragment_burn_history_cm,
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.nav_burn_history_icnf -> navController.navigate(R.id.fragment_burn_history_icnf)
            R.id.nav_burn_history_cm -> navController.navigate(R.id.fragment_burn_history_cm)
